...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      { title: "CENTINELA — Log In" },
      { name: "description", content: "Sign in to your CENTINELA account." },
    ],
  }),
  component: LoginPage,
});
    ...
    >
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 overflow-hidden">
        <div className="w-full max-w-[580px] ">
          ...
          <p className="text-center text-[#94A3B8] text-[20px] mb-8">
            Or choose other way to sign in
          </p>
